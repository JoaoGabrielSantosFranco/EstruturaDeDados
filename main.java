public class main {
    ...
    public static void main(String[] args) {
        System.out.println("");
        System.out.println("CasoMedioBubblesort1<-c ");
        System.out.println("");
        ...
        System.out.println("");
        System.out.println("PiorCasoBubblesort1<-c ");
        for (int i = 1; i < 1001; i++) {
        ...
        System.out.println("");
        System.out.println("CasoMedioinsertionsort<-c ");
        for (int i = 1; i < 1001; i++) {
            int avg[] = averagecase(i);
        ...
        System.out.println("");
        System.out.println("");
        System.out.println("Piorinsertionsort<-c ");
        for (int i = 1; i < 1001; i++) {
            int worst[] = worstcase(i);
        ...
        System.out.println("");
        System.out.println("CasoMedioHeap<-c ");
        for (int i = 1; i < 1001; i++) {
            int avg[] = averagecase(i);
